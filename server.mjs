...
app.get('/api/shop/payment/create', async (req, res) => {
  try {
    ...
    const apiUrl = `https://easydonate.ru/api/v3/shop/payment/create?customer=${customer}&server_id=${process.env.SERVER_ID}&products=${products}&coupon=${coupon}&email=${encodeURIComponent(email)}&success_url=https://mithril.fun`;
